...
AutofocusFixDirective.ɵfac = function AutofocusFixDirective_Factory(t) { return new (t || AutofocusFixDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(DOCUMENT), ɵngcc0.ɵɵdirectiveInject(AutofocusFixConfig)); };
AutofocusFixDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: AutofocusFixDirective, selectors: [["", "autofocus", ""]], inputs: { autofocus: "autofocus", autofocusFixSmartEmptyCheck: "autofocusFixSmartEmptyCheck", autofocusFixTriggerDetectChanges: "autofocusFixTriggerDetectChanges", autofocusFixAsync: "autofocusFixAsync" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()] });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AutofocusFixDirective, [{
        type: Directive,
        args: [{
                selector: '[autofocus]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.ChangeDetectorRef }, { type: Document, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: AutofocusFixConfig }]; }, { autofocus: [{
            type: Input
        }], autofocusFixSmartEmptyCheck: [{
            type: Input
...
AutofocusFixModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AutofocusFixModule });
AutofocusFixModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AutofocusFixModule_Factory(t) { return new (t || AutofocusFixModule)(ɵngcc0.ɵɵinject(AutofocusFixConfig, 8)); } });
/** @nocollapse */
AutofocusFixModule.ctorParameters = () => [
    { type: AutofocusFixConfig, decorators: [{ type: Optional }] }
];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AutofocusFixModule, { declarations: [AutofocusFixDirective], exports: [AutofocusFixDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AutofocusFixModule, [{
        type: NgModule,
        args: [{
                declarations: [AutofocusFixDirective],
                exports: [AutofocusFixDirective]
            }]
    }], function () { return [{ type: AutofocusFixConfig, decorators: [{
                type: Optional
            }] }]; }, null); })();
